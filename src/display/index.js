...
export { DisplayServer, X11DisplayServer, WaylandDisplayServer, createDisplayServer, createDisplayServerSync } from './display-server.js';

/**
 * Convenience re-export of the createDisplayServer function.
 * This is the recommended way to get a display server instance.
 */
export { createDisplayServer as default } from './display-server.js'; 